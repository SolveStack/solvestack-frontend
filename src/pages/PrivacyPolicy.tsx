            ...
            <section>
                <div className="en section_container active" section-language="en">
                    <div id="md_en" data-target="out_en" className="agreement_md">
                        ...
                        <p>
                            Solvestack, LLC ("us", "we", or "our") operates{' '}
                            <a
                                href="https://solvestack.com/"
                                rel="external nofollow noopener noreferrer "
                                target="_blank"
                            >
                                https://solvestack.com
                            </a>{' '}
                        ...
                        <p>
                            ...
                            your device. Other tracking technologies are also used such as beacons, tags and scripts to
                            collect and track information and to improve and analyse our Service. You can instruct your
                            browser to refuse all cookies or to indicate when a cookie is being sent. However, if you do
                            not accept cookies, you may not be able to use some portions of our Service. Examples of
                            Cookies we use:
                        </p>
                        <ul>
                            <li>
                        ...
                        <p>
                            If you are from the European Economic Area (EEA), Solvestack, LLC legal basis for collecting
                            and using the personal information described in this Privacy Policy depends on the Personal
                            Data we collect and the specific context in which we collect it. Solvestack, LLC may process
                        ...
                        <p>
                            Solvestack, LLC will retain your Personal Data only for as long as is necessary for the
                            ...
                            agreements and policies. Solvestack, LLC will also retain Usage Data for internal analysis
                        ...
                        <p>
                            Solvestack, LLC will take all the steps reasonably necessary to ensure that your data is
                        ...
                        <p>
                            If Solvestack, LLC is involved in a merger, acquisition or asset sale, your Personal Data
                            may be transferred. We will provide notice before your Personal Data is transferred and
                            becomes subject to a different Privacy Policy.
                        </p>
                        <h3>Disclosure for Law Enforcement</h3>
                        <p>
                            Under certain circumstances, Solvestack, LLC may be required to disclose your Personal Data
                            if required to do so by law or in response to valid requests by public authorities (e.g. a
                            court or a government agency).
                        </p>
                        <h3>Legal Requirements</h3>
                        <p>
                            Solvestack, LLC may disclose your Personal Data in the good faith belief that such action is
                            necessary to:
                        </p>
                        <ul>
                            <li>To comply with a legal obligation</li>
                            <li>To protect and defend the rights or property of Solvestack, LLC</li>
                        ...
                        <p>
                            ...
                            rights. Solvestack, LLC aims to take reasonable steps to allow you to correct, amend, delete
                        ...
                        <ul>
                            ...
                            <li>
                                <p>
                                    ...
                                    your consent at any time where Solvestack, LLC relied on your consent to process
                        ...
                        <p>
                            Solvestack, LLC uses remarketing services to advertise on third party websites to you after
                            you visited our Service. We and our third-party vendors use cookies to inform, optimise and
                        ...
                        <ul>
                            <li>
                                ...
                                <a
                                    href="https://solvestack.com/contact"
                                    rel="external nofollow noopener noreferrer "
                                    target="_blank"
                                >
                                    https://solvestack.com/contact
                                </a>
                            </li>
                        </ul>
                    </div>
